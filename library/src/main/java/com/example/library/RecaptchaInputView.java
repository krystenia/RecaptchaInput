...
public class RecaptchaInputView extends FrameLayout {
    private int num;
    ...
    private final String Tag = RecaptchaInputView.class.getSimpleName();
    private String pwdStr;
    private OnCompleteLinster mlistener;

    public RecaptchaInputView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RecaptchaInputView);
        num = a.getInt(R.styleable.RecaptchaInputView_num, 4);
        childHPadding = (int) a.getDimension(R.styleable.RecaptchaInputView_child_h_padding, 0);
        childVPadding = (int) a.getDimension(R.styleable.RecaptchaInputView_child_v_padding, 0);
        boxBgId = a.getResourceId(R.styleable.RecaptchaInputView_boxBackground, 0);
        inputType = a.getString(R.styleable.RecaptchaInputView_inputType);
        pwdStr = a.getString(R.styleable.RecaptchaInputView_pwdStr);
        setPwdStr(pwdStr);
        childWidth = (int) a.getDimension(R.styleable.RecaptchaInputView_child_width, 120);
        childHeight = (int) a.getDimension(R.styleable.RecaptchaInputView_child_height, 120);
        textColor = a.getInt(R.styleable.RecaptchaInputView_textColor, Color.BLACK);
        textSize = px2sp(a.getDimensionPixelSize(R.styleable.RecaptchaInputView_textSize, 30));
